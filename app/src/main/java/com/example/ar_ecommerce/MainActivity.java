...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference Medical = FirebaseDatabase.getInstance().getReference("Medical");
        ...
        slideModels.add(new SlideModel(R.drawable.ad6, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.ad7, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.ad8, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.ad9, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.ad10, ScaleTypes.FIT));
        ...
        coat.setVisibility(View.GONE);
        cap.setVisibility(View.GONE);
        frock.setVisibility(View.GONE);
        pant.setVisibility(View.GONE);
        shorts.setVisibility(View.GONE);

        Medical.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    // Example: Check specific keys for visibility
                    long shirtValue = snapshot.child("lesson1").getValue(Long.class);
                    long coatValue = snapshot.child("lesson2").getValue(Long.class);
                    long capValue = snapshot.child("lesson3").getValue(Long.class);
                    long frockValue = snapshot.child("lesson4").getValue(Long.class);
                    long pantValue = snapshot.child("lesson5").getValue(Long.class);
                    long shortsValue = snapshot.child("lesson6").getValue(Long.class);

                    // Update visibility dynamically
                    shirt.setVisibility(shirtValue == 1 ? View.VISIBLE : View.GONE);
                    coat.setVisibility(coatValue == 1 ? View.VISIBLE : View.GONE);
                    cap.setVisibility(capValue == 1 ? View.VISIBLE : View.GONE);
                    frock.setVisibility(frockValue == 1 ? View.VISIBLE : View.GONE);
                    pant.setVisibility(pantValue == 1 ? View.VISIBLE : View.GONE);
                    shorts.setVisibility(shortsValue == 1 ? View.VISIBLE : View.GONE);
                }
            }
        ...
        shirt.setOnClickListener(view -> {
            Intent i = new Intent(MainActivity.this, settingsActivity.class);
            i.putExtra("category", "T-Heart");
            startActivity(i);
        });

        coat.setOnClickListener(view -> {
            Intent i = new Intent(MainActivity.this, settingsActivity.class);
            i.putExtra("category", "C2-Brain");
            startActivity(i);
        });

        cap.setOnClickListener(view -> {
            Intent i = new Intent(MainActivity.this, settingsActivity.class);
            i.putExtra("category", "C3-lungs");
            startActivity(i);
        });

        frock.setOnClickListener(view -> {
            Intent i = new Intent(MainActivity.this, settingsActivity.class);
            i.putExtra("category", "fc4-spinal");
            startActivity(i);
        });

        pant.setOnClickListener(view -> {
            Intent i = new Intent(MainActivity.this, settingsActivity.class);
            i.putExtra("category", "pc5-Kidnyes");
            startActivity(i);
        });

        shorts.setOnClickListener(view -> {
            Intent i = new Intent(MainActivity.this, settingsActivity.class);
            i.putExtra("category", "sc6-urinal");
            startActivity(i);
        });
